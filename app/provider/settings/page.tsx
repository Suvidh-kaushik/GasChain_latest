        ...
        <Card className="md:col-span-1">
          <CardContent className="p-4">
            <nav className="flex flex-col space-y-1">
              <Link
                href="/admin/settings"
                className="flex items-center px-3 py-2 rounded-md text-sm font-medium bg-purple-100 text-purple-600 dark:bg-purple-900 dark:text-purple-200"
              >
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <Label htmlFor="email-documents">Document Uploads</Label>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <Label htmlFor="push-documents">Document Uploads</Label>
                          <p className="text-sm text-muted-foreground">Notifications when new documents are uploaded</p>
                        </div>
